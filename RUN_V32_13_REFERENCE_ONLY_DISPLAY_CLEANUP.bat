...
echo ============================================================
echo V32.13 REFERENCE-ONLY display cleanup
echo ============================================================
echo This is the safer variant: backup files, quarantine test atlases,
echo and zero only reference.nii.gz/reference.tiff.
echo hemispheres.tiff is kept.
echo.
pause
...
"%PY%" "%SCRIPT%" --project-root "%PROJECT_ROOT%" --mode reference-only
pause
