...
if "%NISSL_STACK_ORDER%"=="" set "NISSL_STACK_ORDER=anterior-to-posterior"
...
if /I "%WITH_NISSL%"=="NO" (
    ...
    "%VENV_PY%" "src\ch03_nissl_pipeline.py" ch03-build-from-package "!NISSL_PACKAGE!" "!NISSL_STACK_ORDER!" || goto fail
)
