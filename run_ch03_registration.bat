...
if /I "%~1"=="labels-volume-warp" goto run
...
if /I "%~1"=="abba-package-inspect" goto run
if /I "%~1"=="ch03-import-imagej-stack" goto run
if /I "%~1"=="ch03-build-from-package" goto run
...
echo   run_ch03_registration.bat labels-volume-warp
...
echo   run_ch03_registration.bat abba-package-inspect PATH_TO_QUPATH_PROJECT_FOLDER
echo   run_ch03_registration.bat ch03-import-imagej-stack PATH_TO_STACK anterior-to-posterior
echo   run_ch03_registration.bat ch03-build-from-package PATH_TO_PACKAGE posterior-to-anterior
