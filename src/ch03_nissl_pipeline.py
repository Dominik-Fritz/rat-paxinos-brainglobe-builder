...
def load_package_manifest(package: Path) -> dict:
    ...
    required = {"stack_file", "state_file", "stack_order", "target_sequence_offset"}
...
def import_registered_stack(source: Path, stack_order: str, target_sequence_offset: int) -> dict:
