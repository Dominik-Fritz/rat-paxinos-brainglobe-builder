...
def main(argv: list[str] | None = None) -> int:
    ...
    if report["status"] == "warning":
        ...
        print("ERROR [DISK_SPACE_CRITICAL]: less than 0.5 GiB remains on a required volume.")
        print("Free space before retrying. If C: is affected, also redirect TEMP/TMP to the builder volume.")
        print(r'Example: mkdir G:\paxinos_temp & set TEMP=G:\paxinos_temp & set TMP=G:\paxinos_temp')
