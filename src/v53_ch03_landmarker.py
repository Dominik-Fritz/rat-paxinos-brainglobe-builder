...
def import_imagej_registered_stack(source_path: str, stack_order: str) -> int:
    ...
    # The manually curated package contains WHS 189..776 (588 planes). The
    # Paxinos mask has one additional tiny terminal labeled plane. Excluding
    # that least-populated AP endpoint preserves the manually established
    # one-to-one sequence without interpolating an invented Nissl section.
