...
class AbbaMap(object):
    ...
    def initialize(self, atlasName):
        ...
        # V44_HIDE_NATIVE_BORDERS_DISPLAY_CHANNEL_START
        # Native ABBA borders display channel disabled by V44.
        # The label image remains available through self.annotation_sac / getLabelImage().
        # image_keys.add(JString('borders'))
        # V44_HIDE_NATIVE_BORDERS_DISPLAY_CHANNEL_END
